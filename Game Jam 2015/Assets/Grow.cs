...
public class Grow : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other) {
		if (other.gameObject.tag == "Player") {
			...
			{
				double thisVolume = (4/3)*Mathf.PI*Mathf.Pow(this.transform.lossyScale.x/2.0f,2);
				double otherVolume = (4/3)*Mathf.PI*Mathf.Pow(other.transform.lossyScale.x/2.0f,2);
